		...
		<>
			<main className='bg-gradient-to-b from-blue-50 to-green-50 text-gray-800'>
				...
				<section
					...
					<MotionDiv style={{y, opacity}} className='absolute inset-0 flex items-center justify-center'>
				...
				<section id='mission' className='py-20 bg-gradient-to-b from-pink-50 to-purple-100'>
					<div className='max-w-4xl mx-auto px-4 text-center'>
						<h2 className='text-3xl font-bold mb-8' style={{fontFamily: 'Great Vibes'}}>
							Our Mission
						</h2>
						...
						<MotionDiv className='text-lg text-gray-600 mb-6'>
							<span className='font-serif'>
								Being rooted in Christ our Lord we want to bring light into the darkness of this world to help our fellow women live a life by faith.
				...
				<section id='gospel' className='py-24 bg-gradient-to-b from-purple-200 to-pink-100 font-serif'>
					<div className='max-w-4xl mx-auto px-4 text-center'>
						<MotionH1 className='text-3xl font-bold mb-12 text-center text-pink-800' style={{fontFamily: 'Great Vibes'}}>
							The Gospel of Jesus
						</MotionH1>
						<div className='space-y-6 text-lg text-gray-800 text-center'>
							...
							<p className='text-center'>You are a child of God when you are regenerated by His spirit which leads you to obedience 1 Peter 1:1-2.</p>
							<p className='text-center'>
								Jesus our Lord has gotten victory over sin and over any dominion or authority in this world so we walk in this victory daily.
							</p>
							<p className='text-center'>
					...
					<div className='max-w-4xl mx-auto px-4 text-center'>
						<Card className='p-8'>
							<div className='flex flex-col items-center space-y-6'>
								...
								<h2 className='text-3xl font-bold' style={{fontFamily: 'Great Vibes'}}>
									Have any questions?
								</h2>
