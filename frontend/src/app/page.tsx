...
const StyledCard = styled.div`
  .card {
    width: 250px;
    padding: 1rem;
    background: rgba(255, 235, 240, 0.7); /* Light pink with transparency */
  ...
  .red {
    ...
    box-shadow: -2px 2px 2px rgba(0, 0, 0, 0.2); /* Smaller shadow */
  }
  ...
  .card h1 {
    text-align: center;
    margin: 1rem 0.3rem 0.3rem; /* Adjusted margin */
    color: #2a2a2a;
			...
			<main>
				...
				<section id='mission' className='py-20 bg-gradient-to-b from-pink-50 to-purple-100'>
					<div className='max-w-4xl mx-auto px-4 text-center'>
						<h2 className='text-3xl font-bold mb-8 font-great-vibes'>{t('mission.title')}</h2>
						<motion.p
							variants={fadeInUpVariants}
							initial='hidden'
							animate='visible'
					...
					<div className='max-w-4xl mx-auto px-4 text-center'>
						<Card className='p-8'>
							<div className='flex flex-col items-center space-y-6'>
								...
								<h2 className='text-3xl font-bold font-great-vibes'>{t('contact.title')}</h2>
